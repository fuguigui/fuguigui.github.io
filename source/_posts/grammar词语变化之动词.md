...
- 非现实条件句。从句表示的条件是非现实的，因而主句的动作或者行为是不可能实现的，或者实现的可能性很小；
  ...
  - 从句可用wenn引导，当从句位于主句之前时，连词wenn可以省略；Käme ich nach Berlin, (so) würde ich ihn besuchen.
...
规律来自[简书链接](https://www.jianshu.com/p/87a504d2f710)
